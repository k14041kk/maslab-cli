    ...
    targz.extract(
        ...
        function() {
            ...
            fs.copy(path.join(folder, './' + projectName), folder, function(err) {
                ...
                var graldeProgress = 0;
                setInterval(function() {
                	if(graldeProgress==-1){
                		clearTimeout(this);
                		return;
                	}
  					if(graldeProgress%4==0)process.stdout.write('\r'+'Preparing for Gradle    ');
  					if(graldeProgress%4==1)process.stdout.write('\r'+'Preparing for Gradle.   ');
  					if(graldeProgress%4==2)process.stdout.write('\r'+'Preparing for Gradle..  ');
  					if(graldeProgress%4==3)process.stdout.write('\r'+'Preparing for Gradle... ');
  					graldeProgress++;
				}, 800);
                ...
                ls.stdout.on('data', (data) => {
                	if(graldeProgress!=-1)console.log('');
                	graldeProgress = -1;
